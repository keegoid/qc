...
if [ $IS_SERVER -eq 0 ]; then
   ...
   read -ep "Enter apps to install with apt-get: " -i 'autojump build-essential cmake checkinstall cvs deluge git-core gnupg2 gufw lynx mercurial nautilus-open-terminal subversion silversearcher-ag tmux x11vnc xclip vim-gtk vlc' APTS
